    ...
    public partial class Buchung : Form
    {
        ...
        private void Reserve_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //string connection = "server=localhost;username=root;password=;database=travel_agancy";
                /*string Insert = "insert into clients(`title`, `name`, `surname`, `date_of_birth`, `telephone_number`, `e-mail`) values('" + this.Title.Text + "','" + this.FirstName.Text + "','" + this.Surname.Text + "','" + this.DateOfBirth.Text + "','" + this.TelephoneNumber.Text + "','" + this.E_Mail.Text + "');";
                MySqlConnection mysql = new MySqlConnection(connection);
                MySqlCommand insert = new MySqlCommand(Insert, mysql);
